...
var ABOUT_RESOURCES = [
      {
        "title":"Android TV",
        "titleFriendly":"",
        "summary":"Recommend great content to users right on the home screen. Enable users to find movies through voice search. Engage users with fluid, immersive games. Simple. Cinematic. Beautiful. Made for TV Get Found Recommend Set up your development environment to…",
        "url":"tv/index.html",
        "group":"",
        "keywords": [],
        "tags": [],
...
var TOOLS_RESOURCES = [
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["studio","sdk tools","eclipse adt","sdk manager","google play services","support library"],
        "tags": ["studio","sdktools","eclipseadt","sdkmanager","googleplayservices","supportlibrary"],
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["studio","sdk tools","eclipse adt"],
        "tags": ["studio","sdktools","eclipseadt"],
        "image":"",
        "lang":"en",
        "type":"tools"
      }, 
...
var TRAINING_RESOURCES = [
      ...
      }, 
      {
        ...
        "keywords": ["controller"],
        "tags": ["controller"],
        "image":"images/games/game-controller-buttons_2x.png",
        "lang":"en",
        "type":"training"
      }, 
      {
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["ui","views","layouts","widgets","string resources"],
        "tags": ["ui","views","layouts","widgets","stringresources"],
        "image":"images/viewgroup.png",
        "lang":"en",
        "type":"training"
      }, 
      ...
      }, 
      {
        ...
        "group":"",
        "keywords": ["eclipse adt","sdk tools","project setup"],
        "tags": ["eclipseadt","sdktools","projectsetup"],
        "image":"images/tools/eclipse-new.png",
        "lang":"en",
        "type":"training"
      }, 
      {
        ...
        "group":"",
        "keywords": ["input events","intents","activity lifecycle"],
        "tags": ["inputevents","intents","activitylifecycle"],
...
var DESIGN_BY_TAG = {
    ...
    "beautifulapps":[1], 
    "button":[10,13,27], 
    "input":[10,20,27,59,62], 
    "tabs":[11,58], 
    "actionbar":[11,60], 
    "navigation":[11,43,49,55,58,60,61,62], 
    "viewpager":[11,58], 
    "listview":[12,18,19], 
    "layout":[12,18,30,43,49], 
    "switch":[13], 
    "checkbox":[13], 
    "radiobutton":[13], 
    "progressbar":[14,22], 
...
var DISTRIBUTE_BY_TAG = {
    ...
    "quality":[3,7,11], 
    "gpfe":[5], 
    "googleplay":[5,17,18,39,44,45,46,48], 
    "distribution":[5], 
    "edu":[5], 
    "visibility":[6], 
    "growth":[6,36,37,39,40,42], 
    "distributing":[6], 
    "wear":[7], 
    "wearables":[7], 
    "landing":[11], 
    "disttools":[17,20,22,24], 
    "promoting":[17,19,20], 
    "deviceart":[17,20], 
    "marketing":[17,20], 
    "badge":[18], 
...
var GUIDE_BY_TAG = {
    ...
    "formats":[60], 
    "l10n":[60], 
    "devicepolicymanager":[62], 
    "policy":[62], 
    "security":[62], 
    "ime":[63], 
    "keyboard":[63], 
    "inputmethodservice":[63], 
    "input":[65,66], 
    "spellcheckerservice":[65], 
    "clipboardmanager":[66], 
    "clipdata":[66,146], 
    "database":[75], 
    "sharedpreferences":[75], 
    "sdcard":[75,76], 
    "sensorevent":[78,82], 
    "accelerometer":[78], 
    "gyroscope":[78], 
    ...
    "location":[79], 
    "sensors":[79], 
    "searchrecentsuggestionsprovider":[83,85], 
    "searchrecentsuggestions":[85], 
    "searchview":[86], 
    "mediarouter":[89], 
    "cast":[89], 
    "chromecast":[89], 
    ...
    "soundpool":[95], 
    "audiomanager":[95], 
    "mediarouteprovider":[96], 
    "mediacontrolintent":[96], 
    "home":[97], 
    "appwidgetprovider":[97], 
    "appwidgethost":[98], 
    "homescreen":[98], 
    "launcher":[98], 
    "wireless":[104,105,111], 
    "wifip2pmanager":[104], 
    "wi-fidirect":[104], 
    "wifidirect":[104], 
    "p2p":[104], 
    "wi-fip2p":[104], 
    "wifip2p":[104], 
    "hostcardemulation":[106], 
    "hce":[106], 
    "hostapduservice":[106], 
    "offhostapduservice":[106], 
    "tapandpay":[106], 
    "sipmanager":[115], 
    "sipprofile":[115], 
    "sipaudiocall":[115], 
    ...
    "accessibility":[121], 
    "preference":[125], 
    "preferenceactivity":[125], 
    "preferencefragment":[125], 
    "edittext":[126], 
...
var SAMPLES_BY_TAG = {
    ...
    "elevationdrag":[1], 
    "drawabletinting":[2], 
    "actionbarcompat-shareactionprovider":[3], 
    "basicnotifications":[4], 
    "apprestrictionenforcer":[5], 
    "basicmediadecoder":[6], 
    "cardviewsample":[7], 
    "networkconnect":[8], 
    "bluetoothlegatt":[9], 
    "activityscenetransitionbasic":[10], 
    "speedtracker":[11], 
    "basicimmersivemode":[12], 
    "documentcentricrecents":[13], 
    "swiperefreshlistfragment":[14], 
    "watchviewstub":[15], 
    "horizontalpaging":[16], 
    "notifications":[17], 
    "synchronizednotifications":[18], 
    "mediarouter":[19], 
    "apprestrictionschema":[20], 
    "storageaccessframework":[21], 
    "storage":[21], 
    "documents":[21], 
    "basicsyncadapter":[22], 
    "findmyphone":[23], 
    "advancedimmersivemode":[24], 
    "apprestrictions":[25], 
    "activityinstrumentation":[26], 
    "jumpingjack":[27], 
    "slidingtabscolors":[28], 
    "basicgesturedetect":[29], 
    "basicrenderscript":[30], 
    "customtransition":[31], 
    "actionbarcompat-listpopupmenu":[32], 
    "elizachat":[33], 
    "textlinkify":[34], 
    "hdrviewfinder":[35], 
    "interpolator":[36], 
    ...
    "immersivemode":[44], 
    "quiz":[45], 
    "lnotificationssample":[46], 
    "swiperefreshlayoutbasic":[47], 
    "cardreader":[48], 
    "storageclient":[49], 
    "basicmediarouter":[50], 
    "adaptertransition":[51], 
    "slidingtabsbasic":[52], 
    "flashlight":[53], 
    "basicmanagedprofile":[54], 
    "batchstepsensor":[55], 
    "repeatingalarm":[56], 
    "donebar":[57], 
    "textswitcher":[58], 
    ...
    "actionbarcompat-basic":[66], 
    "skeletonwearableapp":[67], 
    "documentcentricrelinquishidentity":[68], 
    "displayingbitmaps":[69], 
    "recipeassistant":[70], 
    "geofencing":[71], 
    "basicandroidkeystore":[72], 
    "timer":[73], 
    "basicnetworking":[74], 
    "actionbarcompat-styled":[75], 
    "renderscriptintrinsic":[76], 
    "delayedconfirmation":[77], 
    "floatingactionbuttonbasic":[78], 
    "customchoicelist":[79], 
    "jobscheduler":[80], 
    "swiperefreshmultipleviews":[81], 
    "camera2basic":[82], 
    "navigationdrawer":[83], 
    "embeddedapp":[84], 
    "revealeffectbasic":[85], 
    "fragmenttransition":[86], 
    "examples":[90], 
    "code":[90]
};
...
var TRAINING_BY_TAG = {
    ...
    "opengl":[83], 
    "print":[85], 
    "navigation":[85,91,104,227], 
    "gesturedetector":[85,91], 
    "scroller":[85,91], 
    "input":[91,104], 
    "controller":[107], 
    "browsefragment":[109], 
    "presenter":[109], 
    "backgroundmanager":[109], 
    "leanback":[110,113,121], 
    "nowplaying":[111], 
    "mediasession":[111], 
    "detailsfragment":[112], 
    "unsupported":[114], 
    ...
    "geofence":[129], 
    "geofencing":[129], 
    "activityrecognition":[129], 
    "activitydetection":[129], 
    "gps":[129,222], 
    "cursorloader":[137], 
    "edittext":[146], 
    "accessibility":[146], 
    "wifi":[151], 
    "network":[151,216,221,232,294,307], 
    "wireless":[151,232,294], 
    "nfcadapter":[159], 
    "androidbeam":[159], 
    "share":[159,198,212], 
    "filetransfer":[159], 
    ...
    "screens":[297], 
    "versions":[297], 
    "localization":[297,300], 
    "localizing":[300], 
    "notifications":[313,332], 
    "wear":[318,332], 
    "wearable":[318], 
    "app":[318]
};
